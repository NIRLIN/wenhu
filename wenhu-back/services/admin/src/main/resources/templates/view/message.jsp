<%@ page language="java" import="cn.itbaizhan.bean.User" pageEncoding="utf-8" %>
        ...
        <td height="100%" bgcolor="#ffffff">
            <table width="100%" height="100%" cellpadding="0" cellSpacing=0 border=0 borderColor="#ff0000">
                ...
                <tr>
                    ...
                    <td bgcolor="#EAEAEA" onClick="switchSysBar()"
                        style="height:100%;width:12px;text-align:center;cursor:pointer;">
                        <span id="switchPoint" title="打开/关闭左边导航栏"
                              style="color:#666;cursor:hand;font-family:Webdings;font-size:12px;">3</span>
                    </td>
                    <td valign="top">
                                    ...
                                    <c:otherwise>
                                        <c:forEach var="message" items="${list}" varStatus="status">
                                            <tr>
                                                ...
                                                <td width="150px;"><span class="lr10"></span><a style="color:#ff6600;"
                                                                                                href="javascript:del(${message.id });">删除</a>
                                                </td>
                                            </tr>
                                        </c:forEach>
                                    </c:otherwise>

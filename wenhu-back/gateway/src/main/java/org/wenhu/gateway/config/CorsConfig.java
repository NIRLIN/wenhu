package org.wenhu.gateway.config;
...
public class CorsConfig {
    ...
    public CorsWebFilter corsWebFilter() {
        ...
        //支持哪些来源跨域，需要跨域的地址  注意这里的 127.0.0.1 != localhost
        corsConfiguration.addAllowedOrigin("*");
        //跨域请求默认不包含cookie，设置true时可包含cookie
        corsConfiguration.setAllowCredentials(true);

        //Access-Control-Allow-Origin       支持哪些来源跨域，需要跨域的地址  注意这里的 127.0.0.1 != localhost

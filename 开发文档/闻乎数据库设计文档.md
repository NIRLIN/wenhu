...
赞同id、回答OR文章id、用户id、创建时间、修改时间、是否删除
...
反对id、回答OR文章id、用户id、创建时间、修改时间、是否删除

id、parent_id、user_id、、create_time、update_time、is_deleted

```sql
CREATE TABLE `oppose` (
`id` VARCHAR(20) NOT NULL PRIMARY KEY COMMENT '反对id',
`parent_id` VARCHAR(20) COMMENT '回答OR文章id',
`user_id` VARCHAR(10) COMMENT '用户id',
`create_time` datetime COMMENT '创建时间',
`update_time` datetime COMMENT '修改时间',
...
回答收藏id、用户id、回答id、创建时间、修改时间、是否删除
...
文章收藏id、用户id、文章id、创建时间、修改时间、是否删除

id、user_id、article_id、create_time、update_time、is_deleted
